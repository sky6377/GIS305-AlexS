...
def intersect(buffer_layer_list, config_dict):
    lyr_intersect = input("Enter the name for the intersect output layer name: ").strip()
...
def count_addresses(layer_path):
    return int(arcpy.management.GetCount(layer_path).getOutput(0))
